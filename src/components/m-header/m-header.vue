        ...
        <ul ref="ul" :style="{ width: ulWidth + 'px' }">
          <li
            ...
            :class="{
              'router-link-active':
                $route.path ===
                `/` + (item.url === 'analysis' ? 'judge' : item.url),
              close: item.isPermitted == 0,
            }"
          ...
          >
            ...
            <div
              class="modal"
              v-if="item.name === '分析研判' && item.isPermitted !== 0"
            >
              <div
              ...
              <div
                v-show="
                  userInfo.district == 3303 || userInfo.district == 330329
                "
                class="item"
              ...
              <div v-show="userInfo.district == 3303" class="item">
                瑞安安全生产分析
              </div>
              <div v-show="userInfo.district == 3303" class="item">
                鹿城楼宇安全分析
            ...
            <div
              class="modal"
              v-if="item.name === '智能预案' && item.isPermitted !== 0"
            >
              <div
                class="item"
              ...
              <div class="item" style="color: #efefef" @click="jumpYuAn">
                预案管理
              </div>
            </div>
            <div
              class="modal"
              v-if="item.name === '防汛信息管理' && item.isPermitted !== 0"
            >
              <div
                v-show="userInfo.districtName === '瓯海区'"
                class="item"
                @click="
                  goRouter('http://115.223.34.22:8090/fxft2.0/index.html')
                "
                style="color: #efefef"
              >
                防汛标绘
...
.wrapper {
  ...
  top: -0.06rem;
  display: flex;
  background-image: url("http://172.20.83.195:9000/file/map/static/image/background.png");
